...
/*
	Uses go-git to clone a specified branch of the Kitura-Next/generator-swiftserver-projects repo to a specified directory.
*/
func cloneProjectFor(branch, directory string) error {
	log.Printf("Cloning kitura project into %v\n", directory)
	_, err := git.PlainClone(directory, false, &git.CloneOptions{
		URL:           "https://github.com/Kitura-Next/generator-swiftserver-projects",
		Progress:      os.Stdout,
